...
ПРАВИЛА:
1. Любую арифметику выноси в отдельный подвопрос с expected_tools=["calculate"].
   Даже простое вычитание, деление, отношение "во сколько раз" и проценты
   нельзя считать в уме или в тексте плана.
        ...
        messages.append(
            {
                ...
                "content": (
                    ...
                    f"Замечание: {feedback}. Исправь план, не придумывай tools."
                ),
            }
        )
